...
# Calculate theta values based on the number of surface states
# This ensures even distribution around the polar chart
...
# Filter data based on selected season and severe accidents
    ...
    fig.update_layout(
        ...
        polar=dict(
            ...
            angularaxis=dict(
                ...
                rotation=90,
                direction="clockwise",
                # Set a uniform grid line color for better visibility
                linecolor="gray",
                gridcolor="lightgray"
            )
        ),
        ...
        width=900,
        height=800,
        # Ensure legend is visible and well-placed
        legend=dict(
            orientation="h",
            yanchor="bottom",
            y=1.02,
